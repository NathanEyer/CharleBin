...
describe(
    'TopNav', function () {
        describe(
            'showViewButtons & hideViewButtons', function () {
                before(
                    function () {
                        cleanup();
                    }
        ...
        describe(
            'showCreateButtons & hideCreateButtons', function () {
                before(
                    function () {
                        cleanup();
                    }
